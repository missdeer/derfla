...
CODECFORTR      = UTF-8
CODECFORSRC     = UTF-8
TRANSLATIONS    = $$PWD/translations/websearch_en_US.ts \
                  $$PWD/translations/websearch_zh_CN.ts
...
lupdate.commands = $$QMAKE_LUPDATE -no-obsolete $$PWD/websearch.pro
lupdates.depends = $$SOURCES $$HEADERS $$FORMS $$TRANSLATIONS
lrelease.commands = $$QMAKE_LRELEASE $$PWD/websearch.pro
